...
function createMultipleRows(array: { image: string; gameName: string; likes: string; bgColor: string; }[], repeatCount: number) {
    let extendedArray:{ image: string; gameName: string; likes: string; bgColor: string; }[] = [];
...
export default function GamesComponent() {
    ...
    const shuffledGames = shuffleArray([...extendedGames]);
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
                {shuffledGames.map((item, index) => (
                    ...
                    >
                        ...
                        {/* Game Name and Background Color with Opacity */}
                        <div
                            ...
                            style={{
                                backgroundColor: hexToRgba(item.bgColor, 0.8) // Background color with 80% opacity
                            }}
                        >
                            {item.gameName}
                        </div>
